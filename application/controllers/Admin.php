...
class Admin extends CI_Controller {
	...
	public function add()
	{
                ...
                else
                {
					...
					<strong style="color:white">Data Berhasil ditambahkan!</strong>
					</div>');
				redirect('admin');
                }
	...
	public function delete($id_pegawai)
	{
		...
		if($this->db->affected_rows() > 0){
			...
			<strong style="color:white">Data Berhasil Dihapus!</strong>
			</div>');
		}else{
	...
	public function editPegawai()
	{
		if($this->session->userdata('user_type') == "Karyawan"){
			redirect("auth/blocked");
				...
				$this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert">
				<strong style="color:white">Data Berhasil dirubah!</strong>
				</div>');
			redirect('admin');
