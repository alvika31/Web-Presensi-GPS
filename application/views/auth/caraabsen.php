...
<div class="row m-4">
        ...
        <div class="card p-4">
        <h4 class="text-center">Cara Melakukan Presensi di CV. Asian Teknologi Inspira</h4>
        <hr>
            <div class="col-xs-6">
                <p> 1. Silahkan Masuk ke Halaman Login, lalu masukan username dan password yang sudah dikasih oleh admin </p>
            </div>
            <div class="col-xs-6">
            ...
            <br>
            <div class="col-xs-6">
                <p> 2. Setelah Login berhasil izinkan notifikasi lokasi seperti di bawah ini. Agar saat Melakukan Presensi Ketangkap Latitude dan Longatitudenya </p>
            </div>
            <div class="col-xs-6">
