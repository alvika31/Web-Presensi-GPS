                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <?php foreach($jam as $i => $j): ?>
                                <tr id="<?= 'jam-' . $j->id_jam ?>">
                                    <td><h6 class="mb-0 text-xs"><?= ($i+1) ?></h6></td>
                                    <td><h6 class="mb-0 text-xs"><?= $j->keterangan ?></h6></td>
                                    <td class="jam-start"><h6 class="mb-0 text-xs"><?= $j->start ?></h6></td>
                                    <td class="jam-finish"><h6 class="mb-0 text-xs"><?= $j->finish ?></h6></td>
                                    <td>
