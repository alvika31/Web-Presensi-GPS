<main class="main-content position-relative border-radius-lg ">
    <div class="container-fluid py-4">
        <div class="row align-items-end">
            ...
            <div class="col-10" class="align-middle">
                <a href="<?= site_url('absensi/delete_all') ?>" onclick="return confirm('Apakah Yakin Mau Menghapus Semua Data Absensi?')" name="filter" class="btn bg-gradient-danger" style="float: right">Delete All Data</a>
            </div>
            <div class="col-md-2 col-xs-12" class="align-middle">
                <a href="<?= site_url('absensi/export') ?>" name="filter" class="btn bg-gradient-warning" style="float: right">Export To PDF</a>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            <thead>
                                ...
                                <b>Nama Karyawan: </b><?= $namaselect->nama_lengkap ?><br>
                                <?php if (empty($inp)) { ?>
                                    <b>Bulan, Tahun Absen: </b>Semua tanggal<br><br>
                                <?php } else { ?>
                                    <b>Bulan, Tahun Absen: </b><?= date('F, Y', strtotime($inp)) ?><br><br>
                                <?php } ?>
                                ...
                                <?php if (empty($fil)) { ?>
                                    <h6 class="mb-0 text-xs"> <span class="badge badge-md bg-gradient-danger">Data Absensi Belum Ada</span></h6>

                                <?php } else { ?>
                                    <?php $i = 1;
                                    foreach ($fil as $fill) { ?>

                                        <?php $tanggal = strtotime($fill->tgl_absen);
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="<?= site_url('absensi/detailKehadiranPegawai/' . $fill->id_absen) ?>" class="btn btn-info btn-sm" style="padding: 10px" title="Detail Absen">
                                                ...
                                                <a href="<?= site_url('absensi/deleteAbsensi/' . $fill->id_absen) ?>" class="btn btn-danger btn-sm" style="padding: 10px" title="Delete Absensi" onclick="return confirm('Apakah Yakin Mau Menghapus')">
