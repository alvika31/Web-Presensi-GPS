  ...
  <tbody>
    ...
    <tr>
      ...
      <?php if($user->user_type == "Admin"){ ?>
        <h6 class="mb-0 text-xs"> <span class="badge bg-gradient-primary"> <?=$user->user_type?></span></h6>
      <?php }else{?>
...
<div class="col-md-6">
  <div class="form-group">
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Umur" name="umur" required>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group">
